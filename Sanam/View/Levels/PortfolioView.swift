            ...
            VStack(alignment: .center, spacing: 15) {
                ...
                HStack(alignment: .firstTextBaseline, spacing: 6) {
                    Text("سنام")
                        .font(.system(size: 12))
                        .foregroundColor(Color(red: 0.514, green: 0.514, blue: 0.514))
                    Text(arabicNumerals(String(vm.remaining)))
            ...
            VStack(alignment: .center, spacing: 15) {
                ...
                HStack(alignment: .firstTextBaseline, spacing: 6) {
                    Text("سنام")
                        .font(.system(size: 12))
                        .foregroundColor(Color(red: 0.514, green: 0.514, blue: 0.514))
                    Text(arabicNumerals(String(vm.totalBalance)))
                        .font(.system(size: 18, weight: .medium))
        ...
        VStack(spacing: 0) {
            ...
            if isExpanded {
                VStack(spacing: 0) {
                    ...
                    HStack {
                        Text(arabicNumerals(String(Int(sliderMax))))
                            .font(.system(size: 16))
                            .foregroundColor(.primary)
                        Spacer()
                        Text(arabicNumerals(String(Int(sliderMax) / 2)))
                            .font(.system(size: 16))
                            .foregroundColor(.primary)
                        Spacer()
                        Text(arabicNumerals("0"))
                            .font(.system(size: 16))
                            .foregroundColor(.primary)
                    }
                    .padding(.horizontal, 16)
